...
object YtDlpParser {
    ...
    fun parseInfo(title: String, uploader: String? = null, duration: String? = null) = MediaInfo(title, uploader, duration, listOf(MediaFormat("best", "Best", "mp4", true, true)))
    fun cleanError(line: String): String = line.substringAfter("ERROR:", line).trim()
}
